...
function SpecialApproverForm6Content() {
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/50 text-[11px] mt-0.5 font-mono tracking-wide">{submissionNo || '—'}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm">
            ...
            <div className="px-6 py-6 space-y-5">
              ...
              <ReadField label="Trademark &amp; Classes (NICE Classification)" value={trademarkClass} multiline />
              <ReadField label="Artwork or Word" value={artworkOrWord} />
              <ReadField label="Remarks" value={remarks} multiline />
            </div>
          </div>
        </div>
...
export default function SpecialApproverForm6Page() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-gray-50 flex items-center justify-center"><div className="text-gray-600">Loading...</div></div>}>
      <SpecialApproverForm6Content />
    </Suspense>
  );
}
