  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm p-8 flex flex-col items-center text-center">
        ...
        <p className="text-slate-500 text-sm mb-1 leading-relaxed">Registration of a Trademark has been approved.</p>
  ...
  if (step === 'success') return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm p-8 flex flex-col items-center text-center">
        ...
        <p className="text-slate-500 text-sm mb-1 leading-relaxed">Registration of a Trademark has been sent back to the initiator.</p>
        <p className="text-[#1A438A] font-bold text-sm font-mono mb-6">Submission ID : #{submissionNo.split('_').pop()}</p>
  ...
  if (step === 'success') return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm p-8 flex flex-col items-center text-center">
        ...
        <p className="text-slate-500 text-sm mb-1 leading-relaxed">Registration of a Trademark has been rejected and cancelled.</p>
        <p className="text-[#1A438A] font-bold text-sm font-mono mb-6">Submission ID : #{submissionNo.split('_').pop()}</p>
        <button onClick={onClose} className="w-full py-3 rounded-xl font-bold text-white transition-all active:scale-95"
          style={{ background: 'linear-gradient(135deg, #1A438A 0%, #1e5aad 100%)' }}>
          OK
...
function Form6ApprovalPageContent() {
  ...
  // Read submissionId from URL: /form4/approval?id=cmlt1znsi0000...
            ...
            <div className="flex items-center justify-between px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/50 text-[11px] mt-0.5 font-mono tracking-wide">18/FM/1641/07/06</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
...
export default function Form6ApprovalPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-gray-50 flex items-center justify-center"><div className="text-gray-600">Loading...</div></div>}>
      <Form6ApprovalPageContent />
    </Suspense>
  );
}